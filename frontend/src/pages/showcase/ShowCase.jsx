  ...
  return (
    ...
    <div className="min-h-screen text-navyblue relative bg-white py-24">
      ...
      {/* {isMobileSize && (
        ...
        <div className="relative w-full mb-6 p-4 flex flex-col gap-2">
          {/* First Row (5 items) */}
          <div className="w-full mx-auto flex gap-2 md:gap-4 justify-center">
            {firstRow.map((category) => (
              <button
                key={category}
                className={`border md:w-28 lg:w-32 border-[#1b345c] md:text-base text-xs rounded-full p-1.5 px-2 lg:p-3 py-2 transition-all duration-200 ${
                  activeCategory === category
                    ? "bg-[#1b345c] text-white font-semibold"
                    : ""
                }`}
          ...
          {/* Second Row (4 items) */}
          <div className="w-full mx-auto flex flex-wrap gap-2 justify-center">
            {secondRow.map((category, index) => (
              <button
                key={index}
                className={`border md:w-28 lg:w-32 border-[#1b345c] md:text-base text-xs rounded-full p-1.5 px-2 lg:p-3  transition-all duration-200 ${
                  activeCategory === category
                    ? "bg-[#1b345c] text-white font-semibold"
                    : ""
                }`}
      ...
      {/* Main Content */}
      <div className="flex md:flex-row flex-col gap-6 px-6 w-full">
        {/* Left Section - Image */}
              ...
              {activeTypes.map((item, index) => (
                <SwiperSlide>
                  <div
                    ...
                    className={`w-full rounded-md md:h-full shadow-lg cursor-pointer overflow-hidden ${

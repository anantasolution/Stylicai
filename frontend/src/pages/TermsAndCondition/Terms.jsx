...
const Terms = () => {
  return (
    <div className="bg-white rounded-lg shadow-md p-6 md:p-8 py-24">
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-600 mb-4">
          When using our services, the following activities are strictly prohibited:
        </p>
        <ul className="list-disc pl-6 text-gray-600 space-y-2">
          <li>Using our AI to generate illegal, offensive, or harmful content</li>
          <li>Attempting to reverse engineer our AI models</li>
          <li>Scraping or harvesting data from our platform</li>
          <li>Disrupting or interfering with the service's normal operation</li>
          <li>Using automated systems to access the service without explicit permission</li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-600">
          While we strive to provide uninterrupted service, we do not guarantee 24/7 availability. 
          We reserve the right to modify, suspend, or discontinue the service temporarily or 
          permanently with or without notice. We will not be liable for any service interruptions 
          or data loss resulting from such actions.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-600">
          To the maximum extent permitted by law, Ananta Solution and Stylic.ai shall not be 
          liable for any indirect, incidental, special, consequential, or punitive damages resulting 
          from your use or inability to use the service, regardless of whether such damages are 
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-600">
          ...
          the laws of the jurisdiction in which Ananta Solution operates, without regard to 
